...
register_default_namespace() {
    ...
    if ! temporal operator namespace describe "${DEFAULT_NAMESPACE}"; then
        ...
        temporal operator namespace create --retention "${DEFAULT_NAMESPACE_RETENTION}" --description "Default namespace for Dockyard." --history-archival-state "disabled" --visibility-archival-state "disabled" "${DEFAULT_NAMESPACE}"
    else
        echo "Default namespace ${DEFAULT_NAMESPACE} already registered, updating..."
        temporal operator namespace update --retention "${DEFAULT_NAMESPACE_RETENTION}" --description "Default namespace for Dockyard." --history-archival-state "disabled" --visibility-archival-state "disabled" "${DEFAULT_NAMESPACE}"
    fi
