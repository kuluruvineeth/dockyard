...
export function NavLink({ className, ...props }: NavLinkProps) {
  return (
    <ReactRouterNavLink
      ...
      prefetch="intent"
      className={cn(
        "gap-2 inline-flex items-center justify-center whitespace-nowrap px-3 py-2 text-sm font-medium transition-colors duration-150",
        "focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
        "disabled:pointer-events-none disabled:opacity-50",
        "text-grey hover:text-card-foreground",
